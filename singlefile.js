...
<script>
  ...
  const NEW_APPS = [
    ...
    { name: 'YT Link Input', url: 'https://cdn.jsdelivr.net/gh/fidgetsetc/birdmath@main/schoolwork/other/yt.html', img: 'https://cdn.pixabay.com/photo/2022/01/21/00/38/youtube-icon-6953527_1280.jpg' }
  ];
